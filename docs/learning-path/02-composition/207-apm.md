...
- [Module 103 — Agents personnalisés](../01-fondations/103-agents.md) : revoir la création d'agents avant de les partager via APM.
- [Module 104 — Skills](../01-fondations/104-skills.md) : revoir la création de skills avant de les distribuer.
